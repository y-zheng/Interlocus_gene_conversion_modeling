...
gen.analysis.2copy.full = function (pop) {
 ...
 ovec = matrix(0,3,16) #Three vectors for three types of sites
 ovec[1,1:3] = c(rr,gen,sum(hlc2))
...
outhead = paste("Round3.5_OL/Round3.5_purifying_",pur.sel,"_GC_",gcr,"_length_",gcml,"_pnlty_",gc.log,"_rep_",rr,sep="")
...
in.pos = read.table(paste("Round3.5_Initial/Round3.5_inieq_pursel_",pur.sel,"_rep_",rr,"_g40k_pos.txt",sep=""),header=FALSE)[,1]
